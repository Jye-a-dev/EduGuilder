    ...
    <BaseFooter
      left={
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black text-white tracking-wider">EduPath</span>
        </div>
      }
      right={
        <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
          <p className="font-light tracking-wide">&copy; 2026 EduPath Enterprise System. Hợp nhất cấu trúc dữ liệu sạch production[cite: 124].</p>
